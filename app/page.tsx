                ...
                <div className="fixed bottom-4 left-4 z-50">
                    <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 max-w-md shadow-xl">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                            ...
                            OddsAware is designed to help you understand those odds and make informed decisions, but it cannot eliminate the inherent risks.
                            Please gamble responsibly and only within your means.
                        </p>
                        <Button onClick={() => setShowPopup(false)} className="bg-purple-500 hover:bg-purple-600 text-white">
                            I Understand
                        </Button>
                    </div>
                </div>
